...
public class C02_JS_Alerts {
    ...
    @Test
    public void js_Alert_Accept() throws InterruptedException {
        /**
        ...
        String actualResaultText = result.getText();
        String exceptedText = "You successfully clicked an alert";
        Assert.assertEquals(actualResaultText, exceptedText);
    ...
    public void jsAlert_Dismiss() {
        ...
        WebElement result = driver.findElement(By.id("result"));
        String actualResaultText = result.getText();
        String exceptedText = "You clicked: Cancel";
        Assert.assertEquals(actualResaultText, exceptedText);
    }
    @Test
    public void js_Alert_sendKeys() throws InterruptedException {
        /**
         * navigate to https://the-internet.herokuapp.com/javascript_alerts
        ...
        WebElement result = driver.findElement(By.id("result"));
        String actualResaultText = result.getText();
        String exceptedText = "You entered: Ahmet Ay";
        Assert.assertEquals(actualResaultText, exceptedText);
