 ...
 */
  ...
  // * open chrome browser and go to http://www.eurotech.study/
        ...
        Thread.sleep(2000);
  // * click I understand button and accept cookies (by xPath with contains (attribute))
        WebElement Iunderstand = driver.findElement(By.xpath("//button[@aria-label='Accept cookies']"));
        Iunderstand.click();
       ...
       //* locate sign up by xPath with contains (text)
        // * click Sign Up
        WebElement signUpText = driver.findElement(By.xpath("//a[contains(text(),'Sign Up')]"));
        signUpText.click();
