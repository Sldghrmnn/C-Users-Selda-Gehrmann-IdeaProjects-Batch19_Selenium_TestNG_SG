...
public class C01_WebTables {
    ...
    public void printWholeTable(){
        ...
        //driver.get("https://the-internet.herokuapp.com/tables");
        // butun testler bu URL de kullanildigi icin before alindi

        WebElement table = driver.findElement(By.xpath("//table[@id='table1']"));
        String wholeTable = table.getText();

        System.out.println(wholeTable);
        String exceptedText="fbach@yahoo.com";

        Assert.assertTrue(wholeTable.contains(exceptedText));
    }
    @Test
    public void getAllColumnHeaders(){
        ...
        String exceptedText="First Name";

        Assert.assertTrue(columnHeadersText.contains(exceptedText));
