...
public class C03_EditProfileTest extends TestBase {
    ...
    public void editProfile(){
       ...
       // new WebDriverWait(Driver.get(), Duration.ofSeconds(12)).until(ExpectedConditions.visibilityOf(dashboardPage.usernameAtRightTop));
        ...
        //burada page title goyukene kadar bekleme yapiyoruz.
        BrowserUtils.waitForVisibility(userProfilePage.userProfilePageTitle,15);

        //burada ise page title gozukene kadar bekleme yaptiktan sonra,gozuktugunu dogruluyoruz.
        Assert.assertTrue(wait.until(ExpectedConditions.visibilityOf(userProfilePage.usernameAtRightTop)).isDisplayed());
       ...
       // editProfilePage.saveChangesBtn.click();
        ...
        Assert.assertTrue(userProfilePage.profileUpdateMessage.isDisplayed());
