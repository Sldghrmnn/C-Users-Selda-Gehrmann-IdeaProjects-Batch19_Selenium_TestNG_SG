...
public class C05_GetAttributeDemo {
    ...
    public void getAttribute() throws InterruptedException {
       ...
       //child elementleri ile birlikte doner (son child element ise bos doner)
       System.out.println("------------------------------");
       System.out.println("formElement.getAttribute(\"outerHTML\") = " + formElement.getAttribute("outerHTML"));
       //child elementi yoksa sadece kendini doner
       System.out.println("------------------------------");
       ...
       // x,y olarak elemenin koordinatını verir. Action class da kullanılabilir
       System.out.println("------------------------------");
       System.out.println("formElement.getCssValue(\"background\") = " + formElement.getCssValue("background"));
       //style için görünüm değerlerini verir
       System.out.println("------------------------------");
       ...
       //web elementin boyutlarini verir
       System.out.println("------------------------------");
