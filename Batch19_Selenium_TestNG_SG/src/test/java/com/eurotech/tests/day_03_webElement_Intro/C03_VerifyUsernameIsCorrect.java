...
public class C03_VerifyUsernameIsCorrect {
    public static void main(String[] args) throws InterruptedException {
        ...
        //getAttribute() bize secili olan element attribute'leri  hakkinda bilgi verir
        //eger dendKeys() soz konusu ise,gonderilen degeri verir.
       ...
       // WebElement passwordBox = driver.findElement(By.id("password"));
        ...
        //getText()methodu yazilari almak icin kullanilir
