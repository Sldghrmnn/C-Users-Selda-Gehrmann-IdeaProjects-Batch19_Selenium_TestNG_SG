...
public class C01_Actions {
    ...
    public void hoverOver() throws InterruptedException {
       ...
       // Actions actions= new Actions(driver); bu satira gerek yok cunku globale alindi
        ...
        String exceptedText="You can see this paragraph now that you hovered on the above 'button'.";
    ...
    public void rightClickOpenNewWindow() throws InterruptedException {
         ...
         * make right click and open in new tab  (sağ ctrl+click)-EvilTester'a click yapilacak
        ...
        actions.keyDown(Keys.CONTROL).click(evilTester).keyUp(Keys.CONTROL).build().perform();
        ...
        String exceptedTitle="EvilTester.com";
